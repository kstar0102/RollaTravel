...
class AnotherLocationScreen extends ConsumerStatefulWidget{
  const AnotherLocationScreen({super.key});
  @override
  ConsumerState<AnotherLocationScreen> createState() => AnotherLocationScreenState();
}
...
class AnotherLocationScreenState extends ConsumerState<AnotherLocationScreen>{
  ...
  Future<void> _moveMarkerToAddress(String address) async {
    final response = await http.get(
      Uri.parse('https://api.mapbox.com/geocoding/v5/mapbox.places/$address.json?access_token=pk.eyJ1Ijoicm9sbGExIiwiYSI6ImNseGppNHN5eDF3eHoyam9oN2QyeW5mZncifQ.iLIVq7aRpvMf6J3NmQTNAw'),
    );
  ...
  Future<void> _updateAddressFromLocation(LatLng location) async {
    final response = await http.get(
      Uri.parse('https://api.mapbox.com/geocoding/v5/mapbox.places/${location.longitude},${location.latitude}.json?access_token=pk.eyJ1Ijoicm9sbGExIiwiYSI6ImNseGppNHN5eDF3eHoyam9oN2QyeW5mZncifQ.iLIVq7aRpvMf6J3NmQTNAw'),
    );
